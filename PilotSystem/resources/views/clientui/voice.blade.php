...
@section('submain')
    ...
    <div class="widget" ondragstart="return false;">
        ...
        <div class="wrapper statsItems"><!-- 居中 -->
            ...
            <a class="button blackB" onclick="testVoice()" ><span>语音测试开关</span></a> <br /> <br />
            自定义通话键：单机自定义按钮 → 操作（键盘、摇杆）上的通话按键。  <br /><br />
            语音测试开关，测试本地通话，再次单击关闭测试语音； <br /><br />
            断开语音、或被管制踢出语音后，需要重新连线，加入语音通信； <br /><br />
        </div>
