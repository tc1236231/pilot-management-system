<div id="leftSide">
    <div class="logo" onmousemove="onCanvasMouseMove(event)" onmousedown="onCanvasMouseDown(event); return false;"><img src="{{ asset('assets/images/client/loginLogo.png') }}" alt="" style=" width: 110px;" /></div>
