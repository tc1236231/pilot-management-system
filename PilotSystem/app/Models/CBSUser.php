 ...
 * @mixin \Eloquent
 */
class CBSUser extends Model implements
    AuthenticatableContract
{
    //use LaratrustUserTrait;
    use Authenticatable;
    use Notifiable;
    public $connection = 'platform_cbs';
     ...
     */
    protected $fillable = [
        'uid', 'email', 'username', 'password', 'salt'
    ];
    ...
    {
        return $this->hasOne('App\Models\CBSUserDetail','uid', 'uid');
    }
}
